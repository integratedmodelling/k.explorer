/* eslint-disable */
import { dom, uid, QDialog, QList, QItemSection } from 'quasar';
import KeyboardSelectionMixin from './KeyboardSelectionMixins.js';
  ...
  render (h) {
    ...
    return h(QDialog, {
      ...
      h(QList, {
        ...
        this.computedResults.map((result, index) => h(QItemSection, {
          key: result.id || index,
          'class': {
