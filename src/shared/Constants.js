...
export const DEFAULT_STYLES = {
  ...
  light: {
    ...
    'alt-background': 'rgb(233,233,233)',
    'text-color': 'black',
  ...
  worst: {
    ...
    'alt-background': 'fuchsia',
    'text-color': 'red',
    'control-text-color': 'yellow',
    'title-color': 'indigo',
    'alt-color': 'blue',
    'font-family': 'comics',
    'font-size': '1.2em',
...
export const DOCUMENTATION_TYPES_VIEWS = {
  [DOCUMENTATION_TYPES.REPORT]: DOCUMENTATION_VIEWS.REPORT,
  [DOCUMENTATION_TYPES.SECTION]: DOCUMENTATION_VIEWS.REPORT,
  [DOCUMENTATION_TYPES.PARAGRAPH]: DOCUMENTATION_VIEWS.REPORT,
  [DOCUMENTATION_TYPES.TABLE]: DOCUMENTATION_VIEWS.TABLES,
  [DOCUMENTATION_TYPES.CHART]: DOCUMENTATION_VIEWS.REPORT,
  [DOCUMENTATION_TYPES.FIGURE]: DOCUMENTATION_VIEWS.FIGURES,
  [DOCUMENTATION_TYPES.RESOURCE]: DOCUMENTATION_VIEWS.RESOURCES,
  [DOCUMENTATION_TYPES.MODEL]: DOCUMENTATION_VIEWS.MODELS,
  [DOCUMENTATION_TYPES.REFERENCE]: DOCUMENTATION_VIEWS.REPORT,
  [DOCUMENTATION_TYPES.CITATION]: DOCUMENTATION_VIEWS.REPORT,
  [DOCUMENTATION_TYPES.VIEW]: DOCUMENTATION_VIEWS.REPORT,
  [DOCUMENTATION_TYPES.LINK]: DOCUMENTATION_VIEWS.REPORT,
