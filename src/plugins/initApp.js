...
export default ({ store }) => {
  ...
  const local = host.indexOf('integratedmodelling.org') === -1 && host.indexOf('klab.officialstatistics.org') === -1;
  ...
  store.state.view.viewCoordinates = Cookies.get(WEB_CONSTANTS.COOKIE_VIEW_COORDINATES);
